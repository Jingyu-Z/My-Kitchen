...
public class GameInput : MonoBehaviour
{
    ...
    //     {
    //         gameControl.Player.Movement.PerformInteractiveRebinding(1).OnComplete(callback =>{
    ...
    public void ReBinding(BindingType bindingType, Action onComplete)
    {
        ...
        switch(bindingType)
        {
            case BindingType.Up:
                index = 1;
                inputAction = gameControl.Player.Movement;
                break;
    ...
    public string GetBindingDisplayString(BindingType bindingType)
    {
        ...
        {
            case BindingType.Up:
            return gameControl.Player.Movement.bindings[1].ToDisplayString();
            case BindingType.Down:
            return gameControl.Player.Movement.bindings[2].ToDisplayString();
            case BindingType.Left:
            return gameControl.Player.Movement.bindings[3].ToDisplayString();
            case BindingType.Right:
            return gameControl.Player.Movement.bindings[4].ToDisplayString();
            case BindingType.Interact:
    ...
    // private void Start() {
    //     print(gameControl.Player.Movement.bindings[1].ToDisplayString());
    //     print(gameControl.Player.Movement.bindings[2].ToDisplayString());
    //     print(gameControl.Player.Movement.bindings[3].ToDisplayString());
    //     print(gameControl.Player.Movement.bindings[4].ToDisplayString());
   ...
   {
        Vector2 inputVector2 = gameControl.Player.Movement.ReadValue<Vector2>();
